from spell_checker.utils import levenshtein, soundex
from spell_checker.checker import spell_correction
...
def run(option):
    ...
    def option_spell_correction():
        ...
        return f'Possible options: {", ".join(spell_correction(word, "spell_checker/dictionary.txt"))}'
