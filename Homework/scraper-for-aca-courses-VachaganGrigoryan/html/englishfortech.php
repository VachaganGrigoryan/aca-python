...
<html lang="en">
<head>
    <title>English for Tech</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta charset="utf-8">
    <meta name="description" content="Learn business communication basics in tech industry">
    <meta name="keywords" content="English, English for Tech">
    <meta name="author" content="Armenian Code Academy">

    <meta property="og:url" content="http://aca.am/en/techenglish.html"/>
                ...
                <div class="row hide" container-step="2">
                    <div class="jumbotron jumb-costum">
                        <div class="row">
                            <div class="col-xs-12">
                                <form class="form">
                                    <input type="hidden" name="courseName" value="English for Tech" />
...
-->            </div>
            ...
            <div class="col-md-3 col-xs-2 hidden-xs">
                <img src="../assets/img/eft-light.png" alter="courseImage">
            </div>
            <div class="col-md-5 col-sm-10 col-xs-12">
                <h1>English for Tech</h1>
                <p>Learn business communication basics in tech industry</p>
            </div>
                    ...
                    <div class="container">
                            ...
                            <div id="tutors" class="col-xs-12">
                                <div class="container">
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-xs-12">
                                                <img class="img-circle img-thumbnail" src="../assets/img/eft.png"  />

                                            </div>
                                            <div class="col-xs-12">
                                                <h3>“English with Laura”<h3>
                                                <strong><p>A language learning center which uses modern methods of teaching English, namely the Edutainment (education + entertainment) method and Messenger Chatbot.</p></strong>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <p>
This course is designed for tech professionals who want to become confident in business communication in English. In partnership with “English with Laura” training center, we provide a specialized “English for Tech” course fully adjusted for software professionals’ daily routine. Enroll now and get prepared for effective communication with your colleagues, clients, and global partners.
                ...
                <div class="row">
                    <div id="education" class="col-xs-12">
                        <div class="container">
                            ...
                            <div class="header1 col-xs-12">
                                <p>
Lessons consist of lectures and in-class tasks. One of the most efficient methods of learning a foreign language is through immersion. As a teaching method, immersion means that the instruction is given in a foreign language. The class will be conducted exclusively in English. <br />
You will be given homework assignments and will have online access to the materials and resources provided by the tutor.<br />
The mission of English with Laura is to inspire and guide people to learn languages. Therefore, throughout the learning process, the tutor will be available to answer all the questions and eager to make this learning process as smooth and effective as possible.
<br />
                                </p>
                            </div>
                    ...
                    <div id="final" class="col-xs-12">
                        <div class="container">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-10">
                                    <p>
All the topics will include a grammar part, based on real life business situations from tech professional routine.                                </div>
                                <div class="col-xs-2 text-center">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-10">
                                    <p>
Students passing this course will be ready for a daily communication with colleagues and external stakeholders as well as for a participation in different type of scrum ceremonies.                                    </p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12" id="syllabus">
                        <div class="list-group">
                            ...
                            <table class="table table-condensed">
                                ...
                                <tr>
                                    <td>Daily business communication</td>
                                </tr>
                                <tr>
                                    <td>Experience presentation</td>
                                </tr>
                                <tr>
                                    <td>Company presentation</td>
                                </tr>
                                <tr>
                                    <td>Product pitching, Elevator pitch</td>
                                </tr>
                                <tr>
                                    <td>Scrum meetings</td>
                                </tr>
                                <tr>
