...
<html lang="en">
<head>
    <title>ACA | Tech for Non-Tech</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta charset="utf-8">
    <meta name="description" content="Computer Science for Entrepreneurs and Managers">
    <meta name="keywords" content="course, academy, Computer Science, tech for Entrepreneurs, Managers">
    <meta name="author" content="Armenian Code Academy">

    <meta property="og:url" content="http://aca.am/en/ui-ux.html"/>
    <meta property="og:image" content="http://aca.am/assets/img/ui-ux/ui_ux_back.jpg"/>
    ...
    <link href="../assets/css/courses_ui_ux.css" rel="stylesheet">
 ...
 -->                <div class="row " container-step="1">
                    <div class="jumbotron jumb-costum">
                        <div class="row">
                            <div class="col-xs-12">
                                <form class="form">
                                    <input type="hidden" name="courseName" value="Computer Science for Entrepreneurs and Managers" />
                                    <input type="hidden" name="courseID" value="19" />
                                    <input type="hidden" name="courseLevel" value="1" />
                                    <input type="hidden" name="courseStarts" value="[for August 2020]" />
                ...
                <div class="row hide" container-step="2" data-title="Հայտը ընդունված է">
                    <div class="jumbotron jumb-costum">
            ...
            <div class="modal-footer modal-footer-costum">
                <button class="btn btn-success js-btn-step" data-step="1" >
<!--                     <span container-step="1" class="">Next</span>
 -->                    <span container-step="1"class="">Submit</span>
                    <span container-step="2" class="hide">Close</span>
                </button>
            </div>
        </div>
    </div>
...
<!--                 <a href="../hy/ui-ux-lvl2-page.php">
    <span class="flag-icon flag-icon-am"></span>
</a>
 -->               
<!--  <a href="../en/ui-ux-lvl2-page.php" class="active">
...
-->            </div>
        ...
        <div class="row">
            <div class="col-md-3 col-xs-2 hidden-xs">
                <img src="../assets/img/computerscience/logo.png" alter="courseImage">
            </div>
            <div class="col-md-5 col-sm-10 col-xs-12">
                <h1>Tech for Non-Tech</h1>
                <p>Manage your team like a tech pro!</p>
            </div>
            <div class="col-md-4 col-xs-12 text-center">
                <div id="webThanks" class="thanks-for-subscription">
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-xs-12">
                                                ...
                                                src="../assets/img/tutors/JS/level_1/Vrezh_Oganisyan_Simply_Technologies.png"
                                                alt="Vrezh Oganisyan">
                                            </div>
                                            <div class="col-xs-12">
                                                <h3>Vrezh Hovhannisyan<h3>
                                                <strong><p>Chief Technology Officer at Armenian Code Academy
                ...
                <div class="row">
                    <div id="education" class="col-xs-12">
                        <div class="container">
                            ...
                            <div class="header1 col-xs-12">
                                <p>
The course consists of lectures and in-class tasks. The students will also be given homework assignments and home-readings that will be discussed during the class. All the materials assigned by the tutor will be accessible online. Throughout the learning process the tutor will always be available and eager to answer all of your questions and help with any difficulties that you might have.                                </p>
                            </div>
...
<!--                                     <h1>Project Implementation</h1>
                                ...
                                <div id="proj-img" class="col-sm-4 col-xs-12">
<i class="flaticon-drawing8"></i>
                                </div>
                                <div class="col-sm-8 col-xs-12">
<p>
    One of the most important components of our course are the assessment days during which you will present your project to our partner companies.  
</p> -->
                                    <!--<img class="hidden-xs" src="../assets/img/web/project.png"> -->
                                </div>
                            </div>
                        </div>
                    </div>
                    <div id="final" class="col-xs-12">
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-xs-10">
                                    <p>After graduation you will receive a certificate highly valued among the leading IT companies.</p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xs-12">
                                ...
                                <div class="col-xs-10">
                                    <p>
By the end of the course you will have all the necessary skills to have an in-depth understanding of a developing IT project or a product, as well as you will be equipped with all the tools to make tech conversations sound not foreign.                                    </p>
                                </div>
                                <div class="col-xs-2 text-center">
                    ...
                    <div class="col-xs-12" id="syllabus">
                        <div class="list-group">
                            ...
                            <table class="table table-condensed">
                                <tr>
                                    <td>Overview | Tech World</td>
                                </tr>
                                <tr>
                                    <td>Basics of Frontend
                                    <ul>
                                        <li>Browser and Browser API</li>
                                ...
                                <tr>
                                    <td>Basics of Backend
                                    <ul>
                                        <li>Overview of languages, frameworks and tools</li>
                                        <li>Databases</li>
                                ...
                                <tr>
                                    <td>API and What It Is
                                    <ul>
                                                                                <li>Public and Private API's</li>
                                        <li>Postman</li>
                                    </ul>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>Traditional and Cloud Infrastructure
                                    <ul>
                                        <li>Traditional vs Cloud</li>
                                ...
                                <tr>
                                    <td>Overview of Popular Technologies
                                    <ul>
                                        <li>Data Science</li>
                                ...
                                <tr>
                                    ...
                                    <ul>
                                        <li>Refactoring, Debugging</li>
                                        <li>Estimations and Deadlines</li>
                                        <li>Github | Gitlab</li>
                                        <li>Stackoverflow</li>
                                    </ul></td>
                                </tr>
                            ...
                            <div class="list-group">
                                <div class="list-group-item">
                                    <a href="introduction.html">
                                        <p><img class="img-circle" src="../assets/img/courses/intro.png" alter="item1"> Introduction</p>
                                    </a>
                                </div>
                                <div class="list-group-item">
                                    <a href="android.html">
                                        <p><img class="img-circle" src="../assets/img/courses/android.png" alter="item2"> Android</p>
                                    </a>
                                </div>
                                <div class="list-group-item">
                                    <a href="ios.html">
                                        <p><img class="img-circle" src="../assets/img/courses/ios.png" alter="item2"> iOS</p>
                                    </a>
                                </div>
                                <div class="list-group-item">
                                    <a href="algorithms.html">
                                        <p><img class="img-circle" src="../assets/img/courses/alg.png" alter="item3"> Algorithms</p>
                                    </a>
                                </div>
                                <div class="list-group-item">
                                    <a href="python.html">
                                        <p><img class="img-circle" src="../assets/img/courses/Python.png" alter="item3"> Python</p>
                                    </a>
                                </div>
                                <div class="list-group-item">
                                    <a href="java.html">
                                        <p><img class="img-circle" src="../assets/img/courses/java.jpg" alter="item3"> Java</p>
                                    </a>
                                </div>
                            </div>
                        </div>
...
<script src="../assets/js/applicationSteps2En.js"></script>
